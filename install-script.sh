...
COMPOSER_MIRROR_PATH_REPOS=1 ./console composer require --no-interaction --update-with-all-dependencies --minimal-changes "${PACKAGE_NAME}:dev-$CI_COMMIT_BRANCH@dev as $PACKAGE_LATEST_VERSION"
